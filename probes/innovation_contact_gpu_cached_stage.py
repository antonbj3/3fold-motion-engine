"""Isolated two-leg, preallocated raw-generation versus canonical-stage probe."""
...
def main():
    ...
    report={"legs":legs,"backgrounds":backgrounds,"gates":gates,"warm":10,"timed":30,
            "scope":"preallocated standalone stages, raw baseline versus canonical candidate; not full-engine timing"}
    (ROOT/"reports"/"innovation_contact_gpu_cached_stage.json").write_text(json.dumps(report,indent=2)+"\n")
