...
class UnfusedPairContactEngine(GraphColoredContactEngine):
    def __init__(self,**kwargs):
        super().__init__(**kwargs)
        self.KC=dict(self.KC);self.KC['chunk_vel_r']=unfused_pair

class UnfusedColorCacheContactEngine(ColorCacheContactEngine):
    def __init__(self,**kwargs):
        super().__init__(**kwargs)
        self.KC=dict(self.KC);self.KC['chunk_vel_r']=unfused_fixed
